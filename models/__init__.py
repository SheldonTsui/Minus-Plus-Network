...
class ModelBuilder():
    ...
    def build_sound(self, input_nc=1, arch='unet5', fc_dim=64, weights=''):
        # 2D models
        if arch == 'unet5':
            net_sound = Unet(input_nc=input_nc, fc_dim=fc_dim, num_downs=5)
        elif arch == 'unet6':
            net_sound = Unet(input_nc=input_nc, fc_dim=fc_dim, num_downs=6)
        elif arch == 'unet7':
            net_sound = Unet(input_nc=input_nc, fc_dim=fc_dim, num_downs=7)
        else:
